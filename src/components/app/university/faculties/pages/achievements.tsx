...
export default function AchievementsFaculty({ achievements }: { achievements: any }) {
                    ...
                    return (
                        <Dialog key={item.id}>
                            <DialogTrigger asChild>
                                <div className="grid gap-2 border cursor-pointer overflow-hidden rounded-lg text-foreground">
