...
export default function EventDetail({ params, }: PropsData) {
    return (
        <section>
            <div className="flex gap-10 flex-col lg:flex-row">
                <div className="flex-1 flex flex-col gap-4">
                    <div className="flex flex-col gap-4">
                        ...
                        />
                        <h1 className="font-bold text-2xl md:text-3xl lg:text-4xl text-foreground">{params.id} - Event ipsum dolor sit amet.</h1>
                    </div>
